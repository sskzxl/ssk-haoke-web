...
query ssk($pageSize: Int, $pageNum: Int) {
    HouseResourcesList(pageSize: $pageSize, pageNum: $pageNum) {
        records {
                id
                pic
                title
...
class HouseList extends React.Component {
    ...
    componentDidMount = () => {
        ...
        // 查询,然后设置值
        client.query({query: QUERY_LIST, variables: {"pageSize":3,"pageNum":1}}).then(result => {
            this.setState({
