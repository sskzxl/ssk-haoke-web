...
const client = new ApolloClient({
    uri: "http://127.0.0.1:18081/graphql"
});
...
class Home extends React.Component {
  ...
  componentDidMount = () => {
    ...
    let menu = new Promise((resolve, reject) => {
      axios.get('http://127.0.0.1:18081/mock/index/menu').then((data)=>{
        resolve(data.data.list);
      });
    })
    let info = new Promise((resolve, reject) => {
      axios.get('http://127.0.0.1:18081/mock/index/info').then((data)=>{
        resolve(data.data.list);
      });
    })
    let faq = new Promise((resolve, reject) => {
      axios.get('http://127.0.0.1:18081/mock/index/faq').then((data)=>{
        resolve(data.data.list);
      });
    })
    let house = new Promise((resolve, reject) => {
      axios.get('http://127.0.0.1:18081/mock/index/house').then((data)=>{
        resolve(data.data.list);
      });
    })
